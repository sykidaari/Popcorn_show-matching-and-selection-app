  ...
  return (
    ...
    >
      <section className='w-full h-full flex flex-col min-h-20 '>
        ...
        <div className='flex-1 bg-base-200 rounded-box relative flex flex-col items-center min-h-0'>
          {topContent && (
            <div className='w-full p-1.5 mobile:p-2.5'>{topContent}</div>
          )}
          <div className='flex-1 flex items-center justify-center size-full overflow-hidden'>
            {isLoading ? (
